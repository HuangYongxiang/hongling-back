...
import com.hl.photo.table.dao.DaoMaster;
 ...
 * @Copyright: hl
 */
public class PhotoGreenDaoHelper {
    private static PhotoGreenDaoHelper Instance;
    private static DaoMaster daoMaster;
    private static DaoSession daoSession;
    private static String dbName="hl_photo.db";
    private static String dbPath="/hongling/database";
    public static PhotoGreenDaoHelper getInstance() {
        synchronized (PhotoGreenDaoHelper.class){
            if (Instance == null) {
                Instance = new PhotoGreenDaoHelper();
            }
        }
        return Instance;
    }
    ...
    private class MyEncryptedSQLiteOpenHelper extends DaoMaster.OpenHelper {
        ...
        private class MyEncryptedHelper extends net.sqlcipher.database.SQLiteOpenHelper {
            ...
            public void onCreate(net.sqlcipher.database.SQLiteDatabase db) {
                PhotoGreenDaoHelper.MyEncryptedSQLiteOpenHelper.this.onCreate(wrap(db));
            }

            @Override
            public void onUpgrade(net.sqlcipher.database.SQLiteDatabase db, int oldVersion, int newVersion) {
                PhotoGreenDaoHelper.MyEncryptedSQLiteOpenHelper.this.onUpgrade(wrap(db), oldVersion, newVersion);
            }

            @Override
            public void onOpen(net.sqlcipher.database.SQLiteDatabase db) {
                PhotoGreenDaoHelper.MyEncryptedSQLiteOpenHelper.this.onOpen(wrap(db));
            }
