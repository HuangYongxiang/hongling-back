...
public class PreferenceManager {
    ...
    private static final SharedPreferences SHARED_PREFS = PhotoApp.instance().get().getSharedPreferences("PPParkingSharedPreference",
    ...
    public static void remove(final String key) {
        SHARED_PREFS.edit().remove(key).commit();
    }
