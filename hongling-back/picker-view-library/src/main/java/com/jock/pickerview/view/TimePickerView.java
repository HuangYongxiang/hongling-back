...
public class TimePickerView extends BasePickerView implements View.OnClickListener
{
	...
	private TextView textView;//需要显示时间的 view
	public TimePickerView(Context context, Type type)
	{
		...
		// -----确定和取消按钮
		btnSubmit = findViewById(R.id.sure_tv);
...
//		btnCancel.setOnClickListener(this);
		...
		} else
		{
			if (timeSelectListener != null)
			{
				try
				{
					...
					timeSelectListener.onTimeSelect(date,textView);
	...
	public void setOnTimeSelectListener(OnTimeSelectListener timeSelectListener,TextView textView)
	{
