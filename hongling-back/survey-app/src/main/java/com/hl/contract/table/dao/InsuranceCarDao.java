...
/** 
 * DAO for table "INSURANCE_CAR".
*/
public class InsuranceCarDao extends AbstractDao<InsuranceCar, String> {

    public static final String TABLENAME = "INSURANCE_CAR";

    /**
     * Properties of entity InsuranceCar.<br/>
    ...
    public InsuranceCarDao(DaoConfig config) {
        super(config);
    }
    
    public InsuranceCarDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"INSURANCE_CAR\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"INSURANCE_CAR\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, InsuranceCar entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, InsuranceCar entity) {
        stmt.clearBindings();
    ...
    @Override
    public InsuranceCar readEntity(Cursor cursor, int offset) {
        InsuranceCar entity = new InsuranceCar( //
    ...
    @Override
    public void readEntity(Cursor cursor, InsuranceCar entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(InsuranceCar entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(InsuranceCar entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(InsuranceCar entity) {
