...
/**
 * Create data： 2017/6/19.
 * Author: liyu
 * Function:承保车辆信息（标的车）
 */
@Entity
public class SurveyAimCar {
    @Id
    private String id;
    ...
    @Generated(hash = 992184023)
    public SurveyAimCar(String id, String flowId, String evalId, String reportCode,
