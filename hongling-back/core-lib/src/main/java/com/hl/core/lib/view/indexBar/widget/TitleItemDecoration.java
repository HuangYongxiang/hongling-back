...
import com.hl.core.lib.view.indexBar.bean.BaseIndexTagBean;
...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#f6f5fb");
    private static int COLOR_TITLE_FONT = Color.parseColor("#999999");
    ...
    public TitleItemDecoration(Context context, List<? extends BaseIndexTagBean> datas) {
        ...
        mPaint = new Paint();
        mBounds = new Rect();
        mTitleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 27, context.getResources().getDisplayMetrics());
